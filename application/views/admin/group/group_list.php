<div class="col-sm-12">
    <div class="row">
        <div class="col-sm-4">
            <button class="btn btn-success btn-sm" onclick="add();">Add Group</button>
        </div>
    ...
    <table class="table table-bordered" >
        <thead>
            <tr>
                <th style="width: 10px;">No</th><th>Group Name</th><th>Status</th><th>Admin</th>
    ...
    <script type="text/javascript">
        ...
        function view(start){
            ...
            $.ajax({
                url         : "<?php echo base_url() ."group/data?q="; ?>" + search + "&start=" +start,
                type        : "GET",
                dataType    : "json",
                ...
                success     : function(data){
                    ...
                    for(a = 1; a < jmlData; a++){
                        ...
                        buatTabel += "<tr>"
                            //membuat penomoran
                            + "<td>" + data[a]["start"] + "</td>"+ "<td>" + data[a]["group_name"] + "</td>"+ "<td>" + data[a]["status"] + "</td>"+ "<td>" + data[a]["admin"] + "</td>"
                    ...
                    document.getElementById('group').innerHTML = buatTabel;
                }
            });
        }
        ...
        function edit(id)
        {
            ...
            $.ajax({
                ...
                success: function(data)
                {
                    ...
                    if(data.status=='Active') document.getElementById("status").checked = true;
        ...
        function remove(id)
        {
          if(confirm('Are you sure delete this data?'))
          {
            // ajax delete data from database
              $.ajax({
                url : "<?php echo base_url() .'group/delete';?>/"+id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
            ...
            <div class="modal-content">
                ...
                <div class="modal-body form">
                    <form action="#" method="post" id="form" class="form-horizontal"> 
                        <input type="hidden" class="form-control" name="group_id" id="group_id" placeholder="Group Id" value="" />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="checkbox" name="status" id="status" value="Active" />Status
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-3">
...
<!--========================================================================================================
End of file group_list.php 
Location: ./application/views/group_list.php 
