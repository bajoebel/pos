...
<div class="col-sm-12">
    ...
    <div class="pull-right" style="border-bottom:solid #000; border-collapse: collapse; border-width: 1px;padding: 10px 0px">
        <form action="<?php echo site_url('laporan/penjualan'); ?>" class="form-inline" method="get">
            <a href="<?php echo base_url() ."laporan/penjualan/detail" ?>" class="btn btn-warning"><i class="fa fa-search-plus"></i></a>
            ...
            <a href="<?php echo base_url() ."laporan/penjualan/print.html"; if(!empty($from) || !empty($to)) echo "?from=" .$from ."&to=" .$to; ?>" class="btn btn-default"><i class="fa fa-print"></i></a>
            <a href="<?php echo base_url() ."laporan/penjualan/pdf.html"; if(!empty($from) || !empty($to)) echo "?from=" .$from ."&to=" .$to; ?>" class="btn btn-danger"><i class="fa fa-file-pdf-o"></i></a>
            <a href="<?php echo base_url() ."laporan/penjualan/excel.html"; if(!empty($from) || !empty($to)) echo "?from=" .$from ."&to=" .$to; ?>" class="btn btn-success"><i class="fa fa-file-excel-o"></i></a>
        </form>
    </div>
    <div class="row">
        <div class="col-md-10">
...
Location: ./application/views/laporan_penjualan.php 
