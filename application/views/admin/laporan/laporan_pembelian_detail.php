...
<div class="col-sm-12">
    ...
    <div class="pull-right" style="border-bottom:solid #000; border-collapse: collapse; border-width: 1px;padding: 10px 0px">
        <form action="<?php echo site_url('laporan/pembelian/detail'); ?>" class="form-inline" method="get">
            <a href="<?php echo base_url() ."laporan/pembelian" ?>" class="btn btn-warning"><i class="fa fa-search-minus"></i></a>
            ...
            <a href="<?php echo base_url() ."laporan/pembelian/detail/print.html"; if(!empty($from) || !empty($to)) echo "?from=" .$from ."&to=" .$to; ?>" class="btn btn-default"><i class="fa fa-print"></i></a>
            <a href="<?php echo base_url() ."laporan/pembelian/detail/pdf.html"; if(!empty($from) || !empty($to)) echo "?from=" .$from ."&to=" .$to; ?>" class="btn btn-danger"><i class="fa fa-file-pdf-o"></i></a>
            <a href="<?php echo base_url() ."laporan/pembelian/detail/excel.html"; if(!empty($from) || !empty($to)) echo "?from=" .$from ."&to=" .$to; ?>" class="btn btn-success"><i class="fa fa-file-excel-o"></i></a>
        </form>
    </div>
    <div class="row">
        <div class="col-md-12">
