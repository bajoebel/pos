    ...
    <div class="row">
        ...
        <div class="col-md-2 ">
            <div class="pull-right">
                <a href="<?php echo base_url() ."laporan/barang_exp/print" ?>" class="btn btn-default btn-xs" target="_blank"><span class="fa fa-print"></span></a>
                <a href="<?php echo base_url() ."laporan/barang_exp/pdf" ?>" class="btn btn-danger btn-xs" target="_blank"><span class="fa fa-file-pdf-o"></span></a>
                <a href="<?php echo base_url() ."laporan/barang_exp/excel" ?>" class="btn btn-success btn-xs" target="_blank"><span class="fa fa fa-file-excel-o"></span></a>
            </div>
