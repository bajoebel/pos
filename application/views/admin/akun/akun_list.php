<div class="col-sm-12">
    <div class="row">
        <div class="col-sm-4">
            <button class="btn btn-success btn-sm" onclick="add();">Add Akun</button>
        </div>
    ...
    <table class="table table-bordered" >
        <thead>
            <tr>
                <th style="width: 10px;">No</th><th>Akun Kode</th><th>Akun Nama</th><th>Akun Jenis</th><th>Akun Status</th>
    ...
    <script type="text/javascript">
        ...
        function view(start){
            ...
            $.ajax({
                url         : "<?php echo base_url() ."akun/data?q="; ?>" + search + "&start=" +start,
                type        : "GET",
                dataType    : "json",
                ...
                success     : function(data){
                    ...
                    for(a = 1; a < jmlData; a++){
                        ...
                        buatTabel += "<tr>"
                            //membuat penomoran
                            + "<td>" + data[a]["start"] + "</td>"+ "<td>" + data[a]["akun_kode"] + "</td>"+ "<td>" + data[a]["akun_nama"] + "</td>"+ "<td>" + data[a]["akun_jenis"] + "</td>"+ "<td>" + data[a]["akun_status"] + "</td>"
                    ...
                    document.getElementById('akun').innerHTML = buatTabel;
                }
            });
        }
        ...
        function edit(id)
        {
            ...
            $.ajax({
                url : "<?php echo base_url() .'akun/edit'?>/" + id,
                type: "GET",
                dataType: "JSON",
                success: function(data)
                {
                    ...
                    $('#akun_jenis').val(data.akun_jenis);
                    if(data.akun_status=='Aktif') document.getElementById("akun_status").checked = true;
        ...
        function remove(id)
        {
          if(confirm('Are you sure delete this data?'))
          {
            // ajax delete data from database
              $.ajax({
                url : "<?php echo base_url() .'akun/delete';?>/"+id,
                type: "POST",
                dataType: "JSON",
                success: function(data)
                {
            ...
            <div class="modal-content">
                ...
                <div class="modal-body form">
                    <form action="#" method="post" id="form" class="form-horizontal"> 
                        <input type="hidden" class="form-control" name="akun_id" id="akun_id" placeholder="Akun Id" value="" />
                        <div class="form-group">
                            <div class="col-md-3">
                                <label for="varchar">Akun Kode</label>
                            </div>
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="akun_kode" id="akun_kode" placeholder="Akun Kode" value="" />
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-3">
                                <label for="varchar">Akun Nama</label>
                            </div>
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="akun_nama" id="akun_nama" placeholder="Akun Nama" value="" />
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-3">
                                <label for="varchar">Akun Jenis</label>
                            </div>
                            <div class="col-md-9">
                                <select class="form-control" name="akun_jenis" id="akun_jenis " placeholder='Akun Jenis'>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="checkbox" name="akun_status" id="akun_status" value="Aktif" />Akun Status
                            </div>
                        </div>
                    </form>
                </div>
...
<!--========================================================================================================
End of file akun_list.php 
Location: ./application/views/akun_list.php 
